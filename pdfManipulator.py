...
if __name__ == '__main__':
    ...
    # filepathMerge = os.path.join(sys.path[0],"users","user1","Chemistry 12U - Student Text PDF (Online)","13-12-2021_19h-29m-36s","Chemistry 12U - Student Text PDF (Online)"+".pdf")
    ...
    # mergePdfs(inputPdfPaths = [os.path.join(pathTmp, file) for file in sorted(os.listdir(pathTmp), key=lambda x: int(os.path.splitext(x)[0]))], outputPdfPath = filepathMerge)
    pass